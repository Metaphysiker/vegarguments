...
class ArgumentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create argument" do
    assert_difference('Argument.count') do
      post arguments_url, params: { argument: { answer: @argument.answer, question: @argument.question, title: @argument.title } }
    end
  ...
  test "should update argument" do
    patch argument_url(@argument), params: { argument: { answer: @argument.answer, question: @argument.question, title: @argument.title } }
